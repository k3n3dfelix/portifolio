...
export default function Principal(props: PrincipalProps) {
  return (
    <div className="w-full flex flex-col items-center justify-center h-[500px] bg-[url('/principal.jpg')] bg-cover bg-center">
      <Cabecalho />
      <div className="flex-1 w-full flex flex-col justify-center items-center gap-5">
        <div className="flex flex-col items-center gap-5">
          <h1 className="flex gap-3 items-center">
            <span className="w-2 h-2 rounded-full bg-red-500"></span>
            <span className="text-3xl sm:text-5xl font-bold tex-center text-white">
              Kened Felix
            </span>
            <span className="w-2 h-2 rounded-full bg-red-500"></span>
          </h1>
